...
def _map_prediction(score: float) -> tuple[str, float, str]:
    if score >= 0.7:
        return "Likely AI Generated", score, "High AI-like signal across sentences."
    if score >= 0.4:
        return "Suspicious", score, "Mixed signals with moderate AI-like patterns."
    return "Likely Human Written", score, "Sentence-level patterns are consistent with authentic writing."
